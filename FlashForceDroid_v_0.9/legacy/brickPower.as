...
import org.flintparticles.twoD.zones.*;
  ...
  import fl.motion.easing.Back;
	...
	public class brickPower extends MovieClip{
		...
		//var aBall:Ball;
		public function brickPower(enPaddle:enemyPaddle,paddle:MovieClip,ball:MovieClip,theBall:Ball,ePaddle:MovieClip,eSight:MovieClip,startB:Button,myX:Number,myY:Number,level:Array,bricksH:Bricks,stageR:Stage,mainR:FlashForceMain){//,count:int) {
		...
		public function selfDestruct2(){
			if (ball.killAll == 1){
				...
				deathTimer.removeEventListener(TimerEvent.TIMER_COMPLETE, death);
				this.removeEventListener(Event.ENTER_FRAME, waitToDie)
				ball.startButton.removeEventListener(MouseEvent.CLICK, selfDestruct)//this isn't getting added back...
				ball.bricksDestroyed += 1;
