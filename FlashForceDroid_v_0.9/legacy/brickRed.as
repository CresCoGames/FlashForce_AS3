...
--finally, the stuckhandler needs to be revised (ball can get caught at least in upper-right corner)
	...
	--look into the possiblity of dispatching a hitTestObject event for test purposes...
	  $would be better to "fool" the hitTestObject method into returning true, or putting i na debug option to force ball1,ball2, and a ninj star onto a brick at once and so forth to verify that our control structure works as intended.
*/

//put in a period several milliseconds long where ball2 exists but no longer processes waittodie.  This will ensure it doesn't stay on if its
//death is called while it is processing a contact with a brick.
...
import org.flintparticles.twoD.zones.*;
  ...
  import fl.motion.easing.Back;
	...
	public class brickRed extends MovieClip{
		...
		public function brickRed(enPaddle:enemyPaddle,paddle:MovieClip,ball:MovieClip,theBall:Ball,ePaddle:MovieClip,eSight:MovieClip,startB:Button,myX:Number,myY:Number,level:Array,bricksH:Bricks,mainR:FlashForceMain){//,count:int) {
